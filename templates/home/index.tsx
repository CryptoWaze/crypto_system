...
export function HomeTemplate() {
  return (
    <main className="flex h-screen flex-col overflow-hidden">
      <header className="fixed inset-x-0 top-0 z-10 flex h-14 w-full items-center justify-between border-b border-border bg-[#303135]/95 px-4 backdrop-blur sm:px-6" style={{ boxShadow: '0 1px 0 0 rgba(91, 141, 239, 0.06)' }}>
